...
<p align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/version-3.3-blue.svg" alt="Version"></a>
...
-   **WebRTC Leak Prevention:** Disables non-proxied UDP connections in WebRTC to prevent your real IP address from being exposed, even when using a VPN.
...
The extension popup provides the following features:



- **Scan for Leaks:** Manually trigger a scan of the current page for IP leaks.

- **IPv6 Detection:** Toggle IPv6 detection on or off.

- **Export Logs (CSV):** Export the log of detected leaks to a CSV file.

- **Clear Logs:** Clear the log of detected leaks.

- **Show Leak Logs:** Toggle the display of the leak log.
